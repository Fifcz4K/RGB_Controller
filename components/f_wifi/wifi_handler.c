...
static void wifi_init_sta(void)
{
    ...
    char* mySSID = wifiGetSsid();
    char* myPass = wifiGetPassword();
    memcpy(&wifi_config.sta.ssid, mySSID, strlen(mySSID));
    memcpy(&wifi_config.sta.password, myPass, strlen(myPass));
